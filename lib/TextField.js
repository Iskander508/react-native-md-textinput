    ...
    return (
      <View
        ...
        <FloatingLabel
          ...
          duration={duration}
          posTop={labelPosTop}
          posBottom={labelPosBottom}
          fontLarge={labelFontBottom}
          fontSmall={labelFontTop}
...
TextField.propTypes = {
  ...
  labelPosTop: PropTypes.number,
  labelPosBottom: PropTypes.number,
  labelFontTop: PropTypes.number,
  labelFontBottom: PropTypes.number,
